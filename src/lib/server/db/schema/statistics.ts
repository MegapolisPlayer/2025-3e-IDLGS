...
export const statistics = pgTable('statistics', {
	...
	textbookQuestionsCreated: integer('textbookQuestionsCreated')
		.notNull()
		.default(0),
	textbookQuestionsReported: integer('textbookQuestionsReported')
		.notNull()
		.default(0),
	courseQuestionsCreated: integer('courseQuestionsCreated')
		.notNull()
		.default(0),
	// ai generated questions that got deleted by teachers
	courseQuestionsReported: integer('courseQuestionsReported')
		.notNull()
		.default(0),
