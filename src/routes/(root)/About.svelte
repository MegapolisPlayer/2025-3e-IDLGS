<section class="mx-auto max-w-4xl p-8 text-black">
	<!-- Hero -->
	...
	<section class="mb-12">
		...
		<div class="grid grid-cols-1 gap-8 md:grid-cols-3">
			...
			<!-- Feature 1 -->
			<div
				class="flex flex-col items-center rounded-lg border p-4 text-center transition-shadow hover:shadow-lg"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					class="mb-2 h-12 w-12 text-indigo-600"
					viewBox="0 0 24 24"
					fill="none"
					stroke="currentColor"
					stroke-width="2"
	...
	<div class="text-center">
		<a
			href="/demo"
			class="inline-block rounded-md bg-emerald-500 px-8 py-3 font-medium text-white transition-colors hover:bg-indigo-700"
		>
			View Demo
		</a>
	</div>
