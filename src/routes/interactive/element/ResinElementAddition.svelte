...
<div class="flex max-h-1/3 grow flex-col gap-2 rounded-xl bg-neutral-600 p-5">
	...
	<div class="grid grid-cols-3 gap-2 overflow-scroll">
		...
		<ResinItemSelect
			...
			name={m.cartesianCoordinateSystem()}
			icon="layout-grid"
		/>
		<ResinItemSelect
			onclick={() => {
		...
		<ResinItemSelect
			...
			name={m.inputTextAreaShortAnswers()}
			icon="keyboard"
		/>
		<ResinItemSelect
			onclick={() => {
