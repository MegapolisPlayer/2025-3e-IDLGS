...
\begin{document}			
	...
	Oficiální certifikace o zabezpečení (a zároveň s tím spojené posílení zabezpečení) a ochraně dat by jednoznačně také mohlo prospět budoucí adopci systému. Jedná se o certifikaci pro, mimo jiné, směrnice EU NIS2 a GDPR, či příprava dokumentu pro DPIA.
